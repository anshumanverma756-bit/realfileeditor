...
export const TOOLS: Tool[] = [
  ...
  { slug: "organize-pdf", name: "Organize PDF", short: "Reorder, delete and extract pages.", category: "pdf" },
  { slug: "watermark-pdf", name: "Add Watermark", short: "Stamp text or a logo across every page.", category: "pdf", built: true },
  { slug: "protect-pdf", name: "Protect PDF", short: "Lock a PDF with a password.", category: "pdf" },
  { slug: "unlock-pdf", name: "Unlock PDF", short: "Remove a password you own.", category: "pdf" },
  { slug: "sign-pdf", name: "Sign PDF", short: "Add a signature and send it off.", category: "pdf" },
  ...
  { slug: "resize-image", name: "Resize Image", short: "Set exact pixel dimensions.", category: "image" },
